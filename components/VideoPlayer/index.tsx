...
const VideoPlayer = ({
    ...
    return (
        ...
        >
            ...
            <div
                className={`relative grow min-w-12 h-0.75 rounded-full max-md:w-auto max-md:grow ${
                ...
                <div
                    className={`absolute top-0 left-0 bottom-0 rounded-full after:absolute after:top-0 after:right-0 after:bottom-0 after:w-1.25 after:rounded-full ${
                        transparent
                            ...
                            : "bg-[#001789]/70 after:bg-[#001789]"
                    }`}
                    style={{ width: `${progress}%` }}
                ></div>
            </div>
            <div
                className={`shrink-0 w-7 ml-4 text-[0.875rem] font-semibold ${
