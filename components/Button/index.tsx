    ...
    return (
        <Component
            className={`relative inline-flex justify-center items-center leading-[1.25rem] font-semibold cursor-pointer transition-all ${
                ...
                isBrand
                    ? "bg-gradient-to-b from-[#1A2FA3] to-[#001789] shadow-[0px_1px_0px_0px_rgba(255,255,255,0.22)_inset,0px_0px_0px_1px_#00125F,0px_3px_4px_-1px_rgba(0,23,137,0.55)] text-[#FCFCFC] after:absolute after:inset-0 after:rounded-xl after:bg-white after:opacity-0 after:transition-opacity hover:after:opacity-10 active:after:opacity-0"
                    : ""
            } ${
                isSmall
                    ? "h-10 px-5 rounded-[0.625rem] text-[0.875rem]"
                    : "h-11 px-6 rounded-xl text-[1rem]"
